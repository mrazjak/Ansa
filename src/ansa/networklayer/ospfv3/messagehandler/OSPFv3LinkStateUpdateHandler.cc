...
OSPFv3LinkStateUpdateHandler::OSPFv3LinkStateUpdateHandler(OSPFv3ProcessIPv6* containingProcess) /*:
 ...
 */
void OSPFv3LinkStateUpdateHandler::processPacket(OSPFv3Packet* packet, OSPFv3InterfaceIPv6* intf, OSPFv3Neighbor* neighbor)
{
