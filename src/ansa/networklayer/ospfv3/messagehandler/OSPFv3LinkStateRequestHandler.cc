...
OSPFv3LinkStateRequestHandler::OSPFv3LinkStateRequestHandler(OSPFv3ProcessIPv6* containingProcess) /*:
    IOSPFv3MessageHandler(containingProcess)*/
{
    process = containingProcess;
}

void OSPFv3LinkStateRequestHandler::processPacket(OSPFv3Packet* packet, OSPFv3InterfaceIPv6* intf, OSPFv3Neighbor* neighbor)
{
