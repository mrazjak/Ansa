...
OSPFv3DatabaseDescriptionHandler::OSPFv3DatabaseDescriptionHandler(OSPFv3ProcessIPv6* containingProcess) /*:
    IOSPFv3MessageHandler(containingProcess)*/
{
    process = containingProcess;
}

void OSPFv3DatabaseDescriptionHandler::processPacket(OSPFv3Packet* packet, OSPFv3InterfaceIPv6* intf, OSPFv3Neighbor* neighbor)
{
